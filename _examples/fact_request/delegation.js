...
function request(appID, appSecret, selfID) {
    return __awaiter(this, void 0, void 0, function () {
        var opts, storageFolder, sdk, source, cert, fact, res, pn, att, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    sdk = _a.sent();
                    source = "supu";
                    cert = new facts_service_1.Delegation([selfID], ['authenticate'], "allow", ['resources:appID2:authentication']);
                    fact = new facts_service_1.FactToIssue("cert", cert.encode(), source, {
                ...
                case 5:
                    ...
                    if (!res) {
                        ...
                        att = facts_service_1.Delegation.parse(pn);
